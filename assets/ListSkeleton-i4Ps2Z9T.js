import{$t as e,Fn as t,Ht as n,Ln as r,On as i,Pn as a,Wt as o,cn as s,kn as c,ln as l,t as u,un as d,xt as f}from"./Typography-2ICqdcDK.js";import{n as p,q as m}from"./index-C3JhE520.js";import{t as h}from"./shared.module-BFNaqUHe.js";function g(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||``}function _(e){return parseFloat(e)}function v(e){return l(`MuiSkeleton`,e)}s(`MuiSkeleton`,[`root`,`text`,`rectangular`,`rounded`,`circular`,`pulse`,`wave`,`withChildren`,`fitContent`,`heightAuto`]);var y=r(t()),b=a(),x=t=>{let{classes:n,variant:r,animation:i,hasChildren:a,width:o,height:s}=t;return e({root:[`root`,r,i,a&&`withChildren`,a&&!o&&`fitContent`,a&&!s&&`heightAuto`]},v,n)},S=c`
  0% {
    opacity: 1;
  }
