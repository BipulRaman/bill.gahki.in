import{Lt as e,O as t,Q as n,Rt as r,S as i,Ut as a,Wt as o,X as s,_t as c,ot as l,qt as u,vt as d,yt as f}from"./Card-k2uok_FN.js";import{n as p,u as m}from"./index-CFhnjBBk.js";import{t as h}from"./shared.module-BiEixs-K.js";function g(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||``}function _(e){return parseFloat(e)}function v(e){return d(`MuiSkeleton`,e)}c(`MuiSkeleton`,[`root`,`text`,`rectangular`,`rounded`,`circular`,`pulse`,`wave`,`withChildren`,`fitContent`,`heightAuto`]);var y=u(o()),b=a(),x=e=>{let{classes:t,variant:n,animation:r,hasChildren:i,width:a,height:o}=e;return l({root:[`root`,n,r,i&&`withChildren`,i&&!a&&`fitContent`,i&&!o&&`heightAuto`]},v,t)},S=r`
  0% {
    opacity: 1;
  }
